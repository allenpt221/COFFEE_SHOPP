...
const BestSelling = () => {
  ...
  return (
    ...
    <h1 className='md:text-2xl text-3xl mb-2 xl:text-start text-center font-semibold mx-5'>Customer Favorite</h1>
  ...
  {bestsellerMatch.map((item) => (
    ...
    >
      ...
      <p className='text-xs text-gray-500 mb-auto line-clamp-2'>{item.description}</p>
